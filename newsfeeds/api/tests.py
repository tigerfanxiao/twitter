...
class NewsFeedApiTests(TestCase):
    ...
    def setUp(self):
        ...
        # create following and follower for dongxie
        for i in range(2):
            followr = self.create_user('dongxie_follower{}'.format(i))
            Friendship.objects.create(from_user=followr, to_user=self.dongxie)
